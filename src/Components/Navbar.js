    ...
    <nav className="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn"
        ...
        <div className="navbar-collapse justify-content-between py-4 py-lg-0" id="navbarCollapse">
            ...
            <div className="navbar-nav ms-auto py-0">
                <Link className="nav-item nav-link" onClick={handleNavLinkClick} to="home">Home</Link>
                <Link className="nav-item nav-link" onClick={handleNavLinkClick} to="about">About</Link>
                <Link className="nav-item nav-link" onClick={handleNavLinkClick} to="skill">Skills</Link>
            ...
            <Link className="nav-item nav-link" onClick={handleNavLinkClick} to="service">Services</Link>
                <Link className="nav-item nav-link" onClick={handleNavLinkClick} to="project">Projects</Link>
                <Link className="nav-item nav-link" onClick={handleNavLinkClick} to="contact">Contact</Link>
            </div>
                {/* </HashRouter> */}
        </div>
    </nav></>
